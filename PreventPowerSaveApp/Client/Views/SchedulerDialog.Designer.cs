...
namespace PreventPowerSave.Client
{
    partial class SchedulerDialog
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.btnAdd = new PreventPowerSave.Client.AButton(this.components);
            this.btnEdit = new PreventPowerSave.Client.AButton(this.components);
            this.btnDelete = new PreventPowerSave.Client.AButton(this.components);
